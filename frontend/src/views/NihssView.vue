    ...
    <el-row :gutter="16">
      ...
      <el-col :span="14">
        <el-card>
          ...
          <el-form :model="nihssForm" label-width="120px">
            <el-form-item label="就诊ID"><el-input v-model="nihssForm.encounterId" /></el-form-item>
            <el-form-item label="患者ID"><el-input v-model="nihssForm.patientId" /></el-form-item>
      ...
      <el-col :span="10">
        <el-card>
          ...
          <el-input v-model="historyQuery.encounterId" placeholder="就诊ID" style="margin-bottom:12px">
            <template #append>
          ...
          <el-timeline v-if="nihssHistory.length > 0">
            <el-timeline-item v-for="record in nihssHistory" :key="record.assessmentId"
              ...
              <el-tag size="small" :type="record.source === 'OFFLINE' ? 'warning' : 'success'">
